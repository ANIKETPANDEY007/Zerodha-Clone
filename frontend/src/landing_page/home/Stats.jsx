        ...
        <div className='containe p-5'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    <h2 className='fs-2 mb-3'>Trust with Confidence</h2>
                ...
                <div className='col-6 p-5'>
                    ...
                    <div className='text-center'>
                        <a href="" className='mx-5' style={{textDecoration : "none"}}>Explore our project <i class="fa-solid fa-arrow-right-long"></i></a>
